...
class MyButton : AppCompatButton {
    ...
    private var isEnabledText: String = context.getString(R.string.enabled_text)
    private var isDisabledText: String = context.getString(R.string.button_text_disabled)
